...
const elif = {
    ...
    education: "Özyeğin University - Psychology (Senior)",
    focus: "Consumer Insights & Sensory Research",
    currentStudy: "Consumer Decision Fatigue (Choice Overload)",
    ...
    achievements: [
        "IELTS 7.5 (C1 Level)",
        "SWPA Conference 2025 Presenter",
        "Duke University Data Science Math Certificate"
    ],
    
    funFact: "Translating human behavior into data points 🧠 → 📊"
};
<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Hammer%20and%20Wrench.png" alt="Tools" width="30" /> Technical Toolkit
<div align="center">
...
<p>
<b>I am looking for a Consumer Insights Internship to apply my analytical and psychological background!</b>
</p>

<a href="mailto:elif.parildar@ozu.edu.tr">
<img src="https://www.google.com/search?q=https://img.shields.io/badge/Send_an_Email-elif.parildar%2540ozu.edu.tr-A855F7%3Fstyle%3Dfor-the-badge%26logo%3Dgmail%26logoColor%3Dwhite" alt="Email"/>
</a>
